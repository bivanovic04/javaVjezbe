...
// konstruktor
        ...
        public boolean intersects(GameObject other) {
            return this.x < other.x + other.width &&
                    ...
                    this.y + this.height > other.y;// provjeravamo da li se pravougaonici preklapaju sa svih strana prvo lijeo i desno pa gore i dolje
        }
   ...
   class MeleeEnemy extends Enemy {
    ...
    class BossEnemy extends Enemy {
        public BossEnemy(String type, int x, int y, int width, int height, int damage, int health) {
            super(type, x, y, width, height, damage * 2, health * 2); // za boss enemy x2 damage i x2 health  
        }
...
// metode
    ...
    //testiramo dodavanjem playera i enemyja
